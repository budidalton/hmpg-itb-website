    ...
    <div className="editorial-shell min-h-screen">
      ...
      <main>
        <section className="grid min-h-[740px] lg:grid-cols-[minmax(0,7fr)_minmax(0,5fr)]">
          <div className="bg-brand-maroon flex px-8 py-20 text-white md:px-14 md:py-24 lg:px-24 lg:pt-32 lg:pb-24">
          ...
          <div className="bg-brand-surface relative overflow-hidden px-8 py-20 md:px-14 md:py-24 lg:px-24">
            <img
              alt=""
              aria-hidden="true"
            ...
            <div className="relative flex min-h-full w-full max-w-[21rem] flex-col justify-center gap-12 md:gap-14">
              ...
              <div>
                ...
                <a
                  className="font-epilogue text-brand-ink mt-2 block text-[2rem] leading-[1.2] font-semibold tracking-[-0.03em] md:text-[2.1rem]"
        ...
        <section className="bg-brand-shell border-brand-stroke/10 border-y px-4 py-20 md:px-8 md:py-28">
          <div className="mx-auto max-w-[1280px]">
            ...
            <div className="border-brand-stroke/10 bg-brand-stroke/10 mx-auto mt-12 grid max-w-[1200px] gap-px overflow-hidden border p-px md:grid-cols-2 lg:grid-cols-4">
              {store.settings.socialLinks.map((social) => {
