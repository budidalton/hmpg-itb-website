...
export function buildReportInputFromForm(
  ...
  const baseValue = applyFieldSections(reportEditorSections, formData, {
    ...
    cardImageSrc: currentValue?.cardImageSrc ?? "",
    coverCaption: currentValue?.coverCaption ?? "",
  ...
  return {
    ...
    cardImageSrc: String(baseValue.cardImageSrc),
    coverCaption: String(baseValue.coverCaption ?? ""),
